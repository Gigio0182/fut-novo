...
export default function MatchPage() {
  ...
  const renderPlayerRow = (name: string) => {
    return (
      <div key={name} className="overflow-hidden rounded-2xl border border-white/10 bg-[#111218] px-3 py-2">
        <div className="flex items-center justify-between gap-2">
          <span className="min-w-0 flex-1 text-base font-semibold leading-tight text-white">{name}</span>
          <div className="flex flex-wrap items-center justify-end gap-2">
            <button
              onClick={() => handleSwitchTeam(name)}
              className="rounded-full border border-[#d2fc38]/25 bg-[#d2fc38]/10 p-1 text-[11px] text-[#d2fc38] transition hover:bg-[#d2fc38]/20"
            ...
            <button
              ...
              className="rounded-full border border-[#d2fc38]/20 bg-[#d2fc38] px-3 py-1 text-xs font-semibold text-[#0a0a0c] transition hover:brightness-95"
